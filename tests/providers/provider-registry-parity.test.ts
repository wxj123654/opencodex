...
const EXPECTED_KEY_PROVIDER_IDS = [
  "anthropic-apikey", "openai-apikey", "meta-model", "umans", "opencode-go", "neuralwatt", "openrouter", "electronhub-coding-plan", "cline-pass", "cline", "orcarouter", "packycode", "bizrouter", "groq", "google", "google-vertex", "azure-openai",
  ...
  "qoder", "qoder-cn", "codebuddy", "codebuddy-cn", "devin-http", "windsurf-api",
];
...
describe("provider registry parity", () => {
  ...
  test("LiteLLM, opencode-free, mimo-free, and devin-http are the registry seeds with optional key authentication", () => {
    ...
    expect(optionalKeyProviders).toEqual(["litellm", "opencode-free", "mimo-free", "devin-http"]);
  });
